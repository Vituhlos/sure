class Transfer < ApplicationRecord
  ...
  def name
    acc = to_account
    if payment?
      acc ? I18n.t("transfer.payment_name", to_account: acc.name) : I18n.t("transfer.unnamed_payment")
    else
      acc ? I18n.t("transfer.name", to_account: acc.name) : I18n.t("transfer.unnamed")
    end
  end
